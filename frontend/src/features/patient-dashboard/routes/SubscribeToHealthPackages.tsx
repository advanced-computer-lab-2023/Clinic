import {
    getHealthPackages, subscribeCreditToHealthPackage,
    subscribeToHealthPackage, subscribeWalletToHealthPackage,
...
export function SubscribeToHealthPackages() {
    const [selectedHealthPackage, setSelectedHealthPackage] = useState<null | string>()
    const [paymentMethod, setPaymentMethod] = useState<'cash' | 'card' | null>(null)
    const [walletMethodIdPackage, setWalletMethodIdPackage] = useState<null | string>()
    const [creditMethodIdPackage, setCreditMethodIdPackage] = useState<null | string>()
